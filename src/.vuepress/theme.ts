...
export default hopeTheme({
  ...
  blog: {
    medias: {
      ...
      Telegram: "https://t.me/mengguyi_diary"
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "GNU/Linux用户 | 超业余级的Golang开发者 | 18 y.o.｜可以叫我 孟古一 古一孟 МЭН ГУИ MengGuyi | 🌈我支持平等 | Nya!",
        intro: "/intro.html",
        //roundAvatar: true
      },
    ...
    "/en/": {
      ...
      blog: {
        description: "GNU/Linux user | Super amateur Golang developer | 18 y.o. | You can call me 孟古一 古一孟 МЭН ГУИ MengGuyi | 🌈Equality for all | Nya!",
        intro: "/en/intro.html",
        //roundAvatar: true
      },
